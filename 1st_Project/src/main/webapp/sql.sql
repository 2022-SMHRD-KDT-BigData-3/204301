...
insert into placeinfo values ('구 시외버스 공용터미널 일대' ,'null','여기는 5·18민주화운동 당시 시외버스 공용터미널이 있던 곳으로, 전남 일원을 잇는 교통 중심지였다. 5월 19일 오후 이곳에서 계엄군의 과잉진압을 규탄하는 대규모 시위가 있었다.', 35.155125, 126.913111, './518images/구시외버스공용터미널 일대.jpg');
>>>>>>> branch 'master' of https://github.com/2022-SMHRD-KDT-BigData-3/2431.git
...
insert into placeinfo values ('주남마을 인근 양민학살지' ,'null','이곳은 5·18민주화운동 당시인 5월 21일 광주 시내에서 조선대학교 뒷산을 넘어 퇴각, 이곳 주남마을에 주둔하던 계엄군은 광주―화순간 도로를 오가는 차량들에게 무차별 총격을 자행하였다.',35.101714, 126.940349, './518images/주남마을인근\ 양민\ 학살지.jpg');
